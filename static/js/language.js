...
function translatePage(lang) {
    const translations = {
        en: {
            ...
            examTimeLimit: "Once you start the exam, you will have exactly 1 hour to complete it.",
            examReadyStart: "Are you ready to start?",
            examAutoSubmit: "The exam will be automatically submitted when time is up.",
            examNoTimer: "You won't be able to pause the timer once started.",
            examInternet: "Make sure you have a good internet connection before starting.",
            ...
            pendingExam: "Pending Exam",
            startNow: "Start Now",
            timeLeft: "Time Left",
            minutesLeft: "minutes left",
            secondsLeft: "seconds left",
            timeUp: "Time's Up!",
            autoSubmitting: "Auto-submitting your exam...",
            examSubmitted: "Exam Submitted",
            reviewExam: "Review Exam",
            backToExams: "Back to Exams",
            totalScore: "Total Score:",
            noExams: "Aún no hay entregas para este examen.",
        ...
        es: {
            ...
            examTimeLimit: "Una vez que inicies el examen, tendrás exactamente 1 hora para completarlo.",
            examReadyStart: "¿Estás listo para comenzar?",
            examAutoSubmit: "El examen se enviará automáticamente cuando el tiempo termine.",
            examNoTimer: "No podrás pausar el temporizador una vez iniciado.",
            examInternet: "Asegúrate de tener una buena conexión a internet.",
